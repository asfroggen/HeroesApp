package com.esaudev.heroesapp.presentation.components
...
import com.esaudev.heroesapp.ui.theme.EXTRA_SMALL_PADDING
import com.esaudev.heroesapp.ui.theme.LightGray
import com.esaudev.heroesapp.ui.theme.StarColor
...
fun calculateStars(rating: Double): Map<String, Int> {
    ...
    emptyStars = maxStarts - (filledStars + halfStars)
    return mapOf(
        "filledStars" to filledStars,
        "halfFilledStars" to halfStars,
