...
class HeroRemoteMediator @Inject constructor(
    ...
    private val heroRemoteKeysDao = heroesDatabase.heroRemoteKeysDao()
    ...
    override suspend fun initialize(): InitializeAction {
        ...
        val diffInMinutes = (currentTime - lastUpdated) / 1000 / 60 // Minutes
    ...
    override suspend fun load(loadType: LoadType, state: PagingState<Int, Hero>): MediatorResult {
        return try {
            ...
            val page = when(loadType) {
                LoadType.REFRESH -> { // When we send the first request
                ...
                LoadType.APPEND -> { // When we need to fetch more data
